...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof supabase === 'undefined') {
        alert("🚨 GAWAT BOS! Mesin Supabase gagal dimuat. Pastikan internet hidup dan file tidak diblokir browser!");
        return;
    }
    ...
    if (tombolMasuk) {
        tombolMasuk.addEventListener('click', (e) => {
            ...
            alert("Sistem Terhubung! Bersiap menjalankan handleLogin()...");
            handleLogin(); // Memanggil fungsi login Bos
        });
    } else {
        alert("🚨 Aneh, ID 'btn-login' tidak ditemukan di HTML Bos!");
    }
});